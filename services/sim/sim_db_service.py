...
def get_orders_to_send_to_sim():
    ...
    query = """ select distinct cust_order_id, external_id, TRANSACTION_EXTENDED_ID, transaction_date_time
                ...
                where processing_status = 2
                  ...
                  -- and transaction_Date_time between TRUNC(SYSDATE-5) and TRUNC(SYSDATE) -- ordenes del dia anterior
                  and transaction_Date_time between to_date('01/04/2020', 'dd/mm/yyyy') and trunc(SYSDATE) -- ordenes para un rango de fecha especifico
